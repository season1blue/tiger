...
if __name__ == '__main__':
    ...
    "gqa_random": f"{args.label_folder}/gqa_pope_seem_random.json",
    "gqa_popular": f"{args.label_folder}/gqa_pope_seem_popular.json",
    "gqa_adversarial": f"{args.label_folder}/gqa_pope_seem_adversarial.json"}
